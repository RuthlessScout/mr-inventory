...
RegisterNetEvent('its-inventory:slotPut')
AddEventHandler('its-inventory:slotPut', function(item)
...
RegisterNetEvent('its-inventory:putInToSlot')
AddEventHandler('its-inventory:putInToSlot',function(item, slot)
	local xPlayer = ESX.GetPlayerFromId(source)
...
RegisterNetEvent('its-inventory:removeFromSlot')
AddEventHandler('its-inventory:removeFromSlot',function(item, slot)
	local xPlayer = ESX.GetPlayerFromId(source)
